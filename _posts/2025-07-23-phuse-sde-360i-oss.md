---
title: "Powering Standards with Code: The Role of Open Source in CDISC 360i (slides)"
date: 2025-07-23 09:00:00 -0500
categories: [Standards, Open-source]
tags: [open-source, phuse, cdisc, data-exchange]
description: "Presentation given at the PHUSE SDE 2025 in West Windsor (NJ) on July 23rd, 2025"
permalink: /phuse-sde-360i-oss/
---

# Powering Standards with Code: The Role of Open Source in CDISC 360i
- Presentation given at the PHUSE SDE 2025 in West Windsor (NJ) on July 23rd, 2025 by [Sam Hume](https://www.linkedin.com/in/sam-hume-dsc) - _Opinions are my own_
...
today. I don't have the time to cover that today, but suffice it to say, we're working on that as well. That's a longer term vision. 
...
A great example of risk-taking can be found in the Dataset-JSON tooling. We actually ran the first Dataset-JSON Hackathon just before v1.0 was released. This was before there were any supporting public comments from the FDA. Folks jumped in there and created lots of tools, including the conversion tools. The conversion tools allowed us to start the PHUSE/CDISC/FDA
submissions pilot. Without those tools, that pilot doesn't happen. During the pilot some feedback included a critical need for Dataset-JSON Viewers. We recently completed that hackathon and a number of great tools were produced. This risk-taking is helping to drive change. This does not happen or happens at a much slower pace, without open-source and risk
taking.
